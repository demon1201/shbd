...
Page({
  ...
  openConfirm: function (e) {
    console.log(e)
      this.setData({
          dialogShow: true,
          playdate:e.currentTarget.dataset.playdate,
  ...
  tapDialogButton(e) {
    ...
    if(e.detail.index==1){
      ...
      let url = app.globalData.URL + '/er/shbd/order_del';
      let data = {
        strPlaydate: _this.data.playdate,
  ...
  get_lists(){
    ...
    wx.getStorage({
      key: "id",
      success: function (user) {
      let url = app.globalData.URL + '/er/shbd/get_myOrder';
      let data = {
        appid: wx.getAccountInfoSync().miniProgram.appId,
        id:user.data,
      };
